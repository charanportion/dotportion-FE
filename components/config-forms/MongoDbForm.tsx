...
export function MongoDbForm({ nodeId }: MongoDbFormProps) {
      ...
      <Popover>
        <PopoverTrigger asChild>
          <Button
            variant="outline"
            role="combobox"
            className="h-7 text-xs justify-between border-border flex-1 bg-transparent"
          >
  ...
  if (!user || !selectedProject) {
    return (
      <div className="text-xs text-muted-foreground p-3 bg-background border border-border rounded">
            ...
            <div className="space-y-1.5">
                ...
                <PopoverTrigger asChild>
                  <FormControl>
                    <Button
                      ...
                      role="combobox"
                      className={cn(
                        "h-8 text-xs justify-between w-full border-border",
              ...
              <Link href={`/projects/${selectedProject._id}/schema`}>
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="h-6 text-[10px] w-full justify-start text-muted-foreground"
                >
