  ...
  return (
    <div
      className={`rounded-md border bg-white w-[200px] overflow-hidden ${
        selected ? "border-cyan-500 ring-1 ring-cyan-500" : "border-neutral-300"
      }`}
    >
      {/* Input Handle */}
      <Handle
      ...
      {/* Header */}
      <div className="flex items-center gap-2 px-2.5 py-2 border-b border-neutral-200 bg-cyan-50">
      ...
      <div className="px-2.5 py-2 space-y-1.5">
        <div className="flex items-center justify-between">
          <span className="text-[10px] text-neutral-500">Token source:</span>
